...
public class JwtTokenUtil {
    ...
    // génère un jeton d'accès JWT en utilisant les informations de l'utilisateur
    // fourni (algorithme de hachage (HS512))
    public String generateAccessToken(User user) {
        // contient le nom d'utilisateur, l'émetteur (iss), la date d'émission (iat) et
    ...
    // obtient les revendications (claims) du jeton, qui contiennent la date
    // d'expiration
