...
public class PublicController {
    ...
    // permet à un utilisateur de se connecter en fournissant un nom d'utilisateur
    ...
    // permet à un utilisateur de s'inscrire en fournissant les informations
    // d'identification
    ...
    public ResponseEntity<User> me() {
        // utilisé pour obtenir l'objet Authentication représentant l'utilisateur
        // connecté
